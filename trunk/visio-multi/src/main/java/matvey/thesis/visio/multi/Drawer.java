...
public class Drawer extends JPanel {
    ...
    public void redraw() {
        ...
        for (int i = 0; i < globals.K; i++) {
            if (globals.positions.contains(i+1)) {
        ...
        switch (globals.aM.state()) {
        case 0:
            newMessage = MESSAGE_STATE_0;
            break;
        case 11:
        case 1:
        	switch (globals.aFR.state()) {
        	case 2:
        ...
        case 31:
        case 3:
        	switch (globals.aT.state()) {
			case 21:
			case 2:
				switch (globals.aTR.state()) {
				case 2:
        ...
        case 41:
        case 4:
        	switch (globals.aR.state()) {
        	case 0:
                newMessage = MESSAGE_STATE_12;
                selectCell(previous = T[globals.K][globals.N], COLOR_CURRENT);
                break;
        	case 1:
        	case 4:
            ...
            case 2:
                ...
                selectCell(previous = T[globals.i - 1][globals.sum], COLOR_SELECT);
                selectCell(prev_sel1 = T[globals.i][globals.sum + globals.M[globals.i-1]], COLOR_CURRENT);
                break;
            case 3:
                newMessage = MESSAGE_STATE_17;
                selectCell(previous = T[globals.i - 1][globals.sum], COLOR_SELECT);
                selectCell(prev_sel1 = T[globals.i][globals.sum], COLOR_CURRENT);
                break;
        	}
        	break;
        case 5:
        ...
        case 6:
            ...
            for (Integer pos: globals.positions) {
                ...
                itemsString += globals.M[pos.intValue()-1];
            }
            itemsString += "]";
        ...
        if (newMessage == null) {
        	SolutionA.logStateHeaders();
        	SolutionA.logStates(globals);
        }
